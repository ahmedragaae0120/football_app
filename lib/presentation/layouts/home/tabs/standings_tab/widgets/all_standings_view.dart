...
class AllStandingsView extends StatelessWidget {
  final StandingsResponse standing;
  const AllStandingsView({super.key, required this.standing});
            ...
            child: Column(
              children: [
                ListTile(
                  ...
                  title: Text(
                    "${standing.league?.name ?? ""} (2021/2022)",
                ...
                ListView.separated(
                  ...
                  itemCount: listOfStandings.length,
